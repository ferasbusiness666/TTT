...
- [ ] **Fix the mobile UI** (Fero, with screenshots — see `05-known-issues.md` for the four specific symptoms: clipped wordmark, missing search, dead space above the tabs, header misbehaving on scroll). Visual fix, explicitly requested. Blocks launch — most readers will be on a phone.
