...
- [ ] Apply the same treatment to `category.html` (it still renders hardcoded `.acard`s and filters them client-side) and to the "MORE FROM TTT" strip at the bottom of `article.html`.
