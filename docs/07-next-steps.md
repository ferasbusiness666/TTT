...
**These are not legal advice and Claude is not a lawyer.** They are an honest, specific description of what TTT does with data, which is the hard part and the part most templates get wrong.
